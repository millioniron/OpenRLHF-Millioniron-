...
def parse_args():
    ...
    parser.add_argument("--model_name_or_path", default="../examples/test_scripts/checkpoint/Qwen2.5-3B-Train_batch256-rollout_batch32-n_samples_per_prompt=8_lr5e-6", type=str)
...
def prepare_data(data_name, args):
    ...
    out_file = f"{output_dir}/{data_name}/{out_file_prefix}_s{args.start}_e{args.end}_m{args.model_name_or_path}.jsonl"
